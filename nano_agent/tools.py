...
class ToolRegistry:
    ...
    def __init__(self, work_dir: str, bash_timeout: int = 120,
        ...
        self._register("stock_history", "Get historical stock prices. Requires: pip install akshare yfinance. A-shares via akshare (600519), US/HK via yfinance (AAPL). Period: 1mo/3mo/6mo/1y/3y/5y.", self.stock_history, {
        ...
        self._register("stock_chart", "Generate stock price chart (PNG). Requires: pip install akshare yfinance matplotlib. Supports line and candle charts. Saves to charts/ directory.", self.stock_chart, {
    ...
    def _format_history(self, df, symbol: str, period: str, is_a: bool, max_rows: int = 16) -> str:
