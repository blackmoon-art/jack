...
class Agent:
    ...
    def _system_prompt(self) -> str:
        parts = [
            ...
            "- 2D geometric shapes, math proofs, triangles, polygons, structural diagrams → `mermaid_chart`",
            "- 3D shapes (cubes, spheres, pyramids, polyhedra) → `ai_image` (mermaid CANNOT do 3D)",
