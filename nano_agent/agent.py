...
class Agent:
    ...
    def _system_prompt(self) -> str:
        parts = [
            ...
            "- Draw/chart/diagram/image/generate → ALWAYS call tool. Text-only is NEVER acceptable for visual requests.",
            "- CRITICAL: When user asks to draw/create/generate ANY visual, ALWAYS call the appropriate tool. Never describe what you would draw — actually draw it. Every 'draw X' request = tool call, zero exceptions.",
